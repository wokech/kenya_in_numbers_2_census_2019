...
ggsave("images/acqui_subcounty_construct_construct/top_subcounty_home_construct_plot.png", width = 6, height = 4)

# Find the bottom 10 subcounties
bottom_subcounty <- table_2_sc_new %>%
  unite(col = "county_sub", c("SubCounty", "County"), sep = ", ", remove = TRUE) %>%
  arrange(Constructed_Perc) %>%
  slice(1:20)
...
ggsave("images/acqui_subcounty_construct/bottom_subcounty_home_construct_plot.png", width = 6, height = 4)

bottom_subcounty_plot + top_subcounty_plot 

ggsave("images/acqui_subcounty_construct/top_bottom_home_construct_plot.png", width = 12, height = 6)
