...
ggsave("sub_pro_3_sex/images/national/male_to_female.png", width = 8, height = 8, dpi = 300)
...
ggsave("sub_pro_3_sex/images/national/male_to_female_per_age.png", width = 8, height = 8, dpi = 300)
