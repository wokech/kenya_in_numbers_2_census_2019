# Kenyan Generations by Universal Classification (Rural) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/rural/pyramid_universal_rural_1.png", width = 12, height = 12, dpi = 300)
