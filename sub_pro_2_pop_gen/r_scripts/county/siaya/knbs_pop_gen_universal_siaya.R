# Kenyan Generations by Universal Classification (Siaya)
...
# Age-sex dataset for Siaya

county_df_age_sex_siaya <- county_df_age_sex |>
  filter(County == "Siaya")

county_df_age_sex_siaya$Age <- as.numeric(county_df_age_sex_siaya$Age)
...
county_df_age_sex_siaya_male <- county_df_age_sex_siaya |> select(Age, Male)
county_df_age_sex_siaya_male$type <- 'male'
county_df_age_sex_siaya_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_siaya_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_siaya_female <- county_df_age_sex_siaya |> select(Age, Female)
county_df_age_sex_siaya_female$type <- 'female'
county_df_age_sex_siaya_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_siaya_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_siaya_total <- county_df_age_sex_siaya |> select(Age, Total)
county_df_age_sex_siaya_total$type <- 'total'
county_df_age_sex_siaya_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_siaya_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/siaya/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/siaya/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/siaya/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
