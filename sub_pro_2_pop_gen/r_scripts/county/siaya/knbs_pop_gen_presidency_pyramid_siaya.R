# Kenyan Generations by Presidential Era (Siaya) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/siaya/pyramid_presidency_siaya_1.png", width = 12, height = 12, dpi = 300)
