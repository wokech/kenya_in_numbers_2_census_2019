# Kenyan Generations by Universal Classification (Siaya) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/siaya/pyramid_universal_siaya_1.png", width = 12, height = 12, dpi = 300)
