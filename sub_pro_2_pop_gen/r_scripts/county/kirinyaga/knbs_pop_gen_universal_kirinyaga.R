# Kenyan Generations by Universal Classification (Kirinyaga)
...
# Age-sex dataset for Kirinyaga

county_df_age_sex_kirinyaga <- county_df_age_sex |>
  filter(County == "Kirinyaga")

county_df_age_sex_kirinyaga$Age <- as.numeric(county_df_age_sex_kirinyaga$Age)
...
county_df_age_sex_kirinyaga_male <- county_df_age_sex_kirinyaga |> select(Age, Male)
county_df_age_sex_kirinyaga_male$type <- 'male'
county_df_age_sex_kirinyaga_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kirinyaga_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kirinyaga_female <- county_df_age_sex_kirinyaga |> select(Age, Female)
county_df_age_sex_kirinyaga_female$type <- 'female'
county_df_age_sex_kirinyaga_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kirinyaga_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kirinyaga_total <- county_df_age_sex_kirinyaga |> select(Age, Total)
county_df_age_sex_kirinyaga_total$type <- 'total'
county_df_age_sex_kirinyaga_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kirinyaga_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kirinyaga/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kirinyaga/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kirinyaga/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
