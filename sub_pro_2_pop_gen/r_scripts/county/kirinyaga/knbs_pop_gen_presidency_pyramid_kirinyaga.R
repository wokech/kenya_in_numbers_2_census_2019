# Kenyan Generations by Presidential Era (Kirinyaga) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kirinyaga/pyramid_presidency_kirinyaga_1.png", width = 12, height = 12, dpi = 300)
