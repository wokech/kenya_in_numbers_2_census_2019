# Kenyan Generations by Universal Classification (Kirinyaga) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kirinyaga/pyramid_universal_kirinyaga_1.png", width = 12, height = 12, dpi = 300)
