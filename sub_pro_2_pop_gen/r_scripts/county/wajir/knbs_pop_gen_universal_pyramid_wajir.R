# Kenyan Generations by Universal Classification (Wajir) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/wajir/pyramid_universal_wajir_1.png", width = 12, height = 12, dpi = 300)
