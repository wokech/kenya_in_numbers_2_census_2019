# Kenyan Generations by Universal Classification (Wajir)
...
# Age-sex dataset for Wajir

county_df_age_sex_wajir <- county_df_age_sex |>
  filter(County == "Wajir")

county_df_age_sex_wajir$Age <- as.numeric(county_df_age_sex_wajir$Age)
...
county_df_age_sex_wajir_male <- county_df_age_sex_wajir |> select(Age, Male)
county_df_age_sex_wajir_male$type <- 'male'
county_df_age_sex_wajir_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_wajir_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_wajir_female <- county_df_age_sex_wajir |> select(Age, Female)
county_df_age_sex_wajir_female$type <- 'female'
county_df_age_sex_wajir_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_wajir_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_wajir_total <- county_df_age_sex_wajir |> select(Age, Total)
county_df_age_sex_wajir_total$type <- 'total'
county_df_age_sex_wajir_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_wajir_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/wajir/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/wajir/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/wajir/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
