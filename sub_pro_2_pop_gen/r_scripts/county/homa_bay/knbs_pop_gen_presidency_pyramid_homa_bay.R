# Kenyan Generations by Presidential Era (Homa Bay) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/homa_bay/pyramid_presidency_homa_bay_1.png", width = 12, height = 12, dpi = 300)
