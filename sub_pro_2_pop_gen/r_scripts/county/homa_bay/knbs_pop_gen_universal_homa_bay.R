# Kenyan Generations by Universal Classification (Homa Bay)
...
# Age-sex dataset for Homa Bay

county_df_age_sex_homa_bay <- county_df_age_sex |>
  filter(County == "Homa Bay")

county_df_age_sex_homa_bay$Age <- as.numeric(county_df_age_sex_homa_bay$Age)
...
county_df_age_sex_homa_bay_male <- county_df_age_sex_homa_bay |> select(Age, Male)
county_df_age_sex_homa_bay_male$type <- 'male'
county_df_age_sex_homa_bay_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_homa_bay_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_homa_bay_female <- county_df_age_sex_homa_bay |> select(Age, Female)
county_df_age_sex_homa_bay_female$type <- 'female'
county_df_age_sex_homa_bay_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_homa_bay_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_homa_bay_total <- county_df_age_sex_homa_bay |> select(Age, Total)
county_df_age_sex_homa_bay_total$type <- 'total'
county_df_age_sex_homa_bay_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_homa_bay_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/homa_bay/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/homa_bay/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/homa_bay/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
