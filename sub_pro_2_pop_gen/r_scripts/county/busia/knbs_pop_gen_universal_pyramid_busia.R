# Kenyan Generations by Universal Classification (Busia) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/busia/pyramid_universal_busia_1.png", width = 12, height = 12, dpi = 300)
