# Kenyan Generations by Presidential Era (Busia) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/busia/pyramid_presidency_busia_1.png", width = 12, height = 12, dpi = 300)
