# Kenyan Generations by Universal Classification (Narok) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/narok/pyramid_universal_narok_1.png", width = 12, height = 12, dpi = 300)
