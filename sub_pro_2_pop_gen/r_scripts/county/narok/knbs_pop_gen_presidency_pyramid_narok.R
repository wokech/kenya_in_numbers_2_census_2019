# Kenyan Generations by Presidential Era (Narok) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/narok/pyramid_presidency_narok_1.png", width = 12, height = 12, dpi = 300)
