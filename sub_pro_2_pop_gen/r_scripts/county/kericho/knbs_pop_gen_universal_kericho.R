# Kenyan Generations by Universal Classification (Kericho)
...
# Age-sex dataset for Kericho

county_df_age_sex_kericho <- county_df_age_sex |>
  filter(County == "Kericho")

county_df_age_sex_kericho$Age <- as.numeric(county_df_age_sex_kericho$Age)
...
county_df_age_sex_kericho_male <- county_df_age_sex_kericho |> select(Age, Male)
county_df_age_sex_kericho_male$type <- 'male'
county_df_age_sex_kericho_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kericho_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kericho_female <- county_df_age_sex_kericho |> select(Age, Female)
county_df_age_sex_kericho_female$type <- 'female'
county_df_age_sex_kericho_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kericho_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kericho_total <- county_df_age_sex_kericho |> select(Age, Total)
county_df_age_sex_kericho_total$type <- 'total'
county_df_age_sex_kericho_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kericho_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kericho/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kericho/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kericho/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
