# Kenyan Generations by Presidential Era (Kericho) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kericho/pyramid_presidency_kericho_1.png", width = 12, height = 12, dpi = 300)
