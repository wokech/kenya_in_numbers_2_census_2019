# Kenyan Generations by Universal Classification (Kericho) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kericho/pyramid_universal_kericho_1.png", width = 12, height = 12, dpi = 300)
