# Kenyan Generations by Presidential Era (Mandera) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/mandera/pyramid_presidency_mandera_1.png", width = 12, height = 12, dpi = 300)
