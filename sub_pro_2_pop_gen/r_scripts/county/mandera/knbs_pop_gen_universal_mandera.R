# Kenyan Generations by Universal Classification (Mandera)
...
# Age-sex dataset for Mandera

county_df_age_sex_mandera <- county_df_age_sex |>
  filter(County == "Mandera")

county_df_age_sex_mandera$Age <- as.numeric(county_df_age_sex_mandera$Age)
...
county_df_age_sex_mandera_male <- county_df_age_sex_mandera |> select(Age, Male)
county_df_age_sex_mandera_male$type <- 'male'
county_df_age_sex_mandera_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_mandera_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_mandera_female <- county_df_age_sex_mandera |> select(Age, Female)
county_df_age_sex_mandera_female$type <- 'female'
county_df_age_sex_mandera_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_mandera_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_mandera_total <- county_df_age_sex_mandera |> select(Age, Total)
county_df_age_sex_mandera_total$type <- 'total'
county_df_age_sex_mandera_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_mandera_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/mandera/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/mandera/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/mandera/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
