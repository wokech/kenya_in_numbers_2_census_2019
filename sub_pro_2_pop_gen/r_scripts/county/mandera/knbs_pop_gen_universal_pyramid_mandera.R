# Kenyan Generations by Universal Classification (Mandera) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/mandera/pyramid_universal_mandera_1.png", width = 12, height = 12, dpi = 300)
