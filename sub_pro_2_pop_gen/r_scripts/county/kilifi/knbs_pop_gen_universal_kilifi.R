# Kenyan Generations by Universal Classification (Kilifi)
...
# Age-sex dataset for Kilifi

county_df_age_sex_kilifi <- county_df_age_sex |>
  filter(County == "Kilifi")

county_df_age_sex_kilifi$Age <- as.numeric(county_df_age_sex_kilifi$Age)
...
county_df_age_sex_kilifi_male <- county_df_age_sex_kilifi |> select(Age, Male)
county_df_age_sex_kilifi_male$type <- 'male'
county_df_age_sex_kilifi_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kilifi_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kilifi_female <- county_df_age_sex_kilifi |> select(Age, Female)
county_df_age_sex_kilifi_female$type <- 'female'
county_df_age_sex_kilifi_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kilifi_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kilifi_total <- county_df_age_sex_kilifi |> select(Age, Total)
county_df_age_sex_kilifi_total$type <- 'total'
county_df_age_sex_kilifi_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kilifi_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kilifi/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kilifi/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kilifi/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
