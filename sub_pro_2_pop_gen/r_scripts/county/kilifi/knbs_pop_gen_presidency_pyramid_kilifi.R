# Kenyan Generations by Presidential Era (Kilifi) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kilifi/pyramid_presidency_kilifi_1.png", width = 12, height = 12, dpi = 300)
