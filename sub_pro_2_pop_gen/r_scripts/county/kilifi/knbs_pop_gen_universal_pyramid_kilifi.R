# Kenyan Generations by Universal Classification (Kilifi) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kilifi/pyramid_universal_kilifi_1.png", width = 12, height = 12, dpi = 300)
