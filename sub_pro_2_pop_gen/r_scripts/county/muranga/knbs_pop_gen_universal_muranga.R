# Kenyan Generations by Universal Classification (Murang'a)
...
# Age-sex dataset for Murang'a

county_df_age_sex_muranga <- county_df_age_sex |>
  filter(County == "Murang'a")

county_df_age_sex_muranga$Age <- as.numeric(county_df_age_sex_muranga$Age)
...
county_df_age_sex_muranga_male <- county_df_age_sex_muranga |> select(Age, Male)
county_df_age_sex_muranga_male$type <- 'male'
county_df_age_sex_muranga_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_muranga_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_muranga_female <- county_df_age_sex_muranga |> select(Age, Female)
county_df_age_sex_muranga_female$type <- 'female'
county_df_age_sex_muranga_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_muranga_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_muranga_total <- county_df_age_sex_muranga |> select(Age, Total)
county_df_age_sex_muranga_total$type <- 'total'
county_df_age_sex_muranga_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_muranga_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/muranga/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/muranga/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/muranga/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
