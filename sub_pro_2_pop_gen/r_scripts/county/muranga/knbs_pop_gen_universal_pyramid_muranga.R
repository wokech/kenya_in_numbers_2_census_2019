# Kenyan Generations by Universal Classification (Murang'a) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/muranga/pyramid_universal_muranga_1.png", width = 12, height = 12, dpi = 300)
