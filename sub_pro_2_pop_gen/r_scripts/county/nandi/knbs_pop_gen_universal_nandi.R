# Kenyan Generations by Universal Classification (Nandi)
...
# Age-sex dataset for Nandi

county_df_age_sex_nandi <- county_df_age_sex |>
  filter(County == "Nandi")

county_df_age_sex_nandi$Age <- as.numeric(county_df_age_sex_nandi$Age)
...
county_df_age_sex_nandi_male <- county_df_age_sex_nandi |> select(Age, Male)
county_df_age_sex_nandi_male$type <- 'male'
county_df_age_sex_nandi_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_nandi_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_nandi_female <- county_df_age_sex_nandi |> select(Age, Female)
county_df_age_sex_nandi_female$type <- 'female'
county_df_age_sex_nandi_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_nandi_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_nandi_total <- county_df_age_sex_nandi |> select(Age, Total)
county_df_age_sex_nandi_total$type <- 'total'
county_df_age_sex_nandi_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_nandi_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/nandi/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nandi/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nandi/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
