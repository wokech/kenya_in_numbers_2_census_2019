# Kenyan Generations by Presidential Era (Nandi) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/nandi/pyramid_presidency_nandi_1.png", width = 12, height = 12, dpi = 300)
