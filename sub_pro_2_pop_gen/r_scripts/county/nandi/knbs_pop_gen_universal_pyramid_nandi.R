# Kenyan Generations by Universal Classification (Nandi) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/nandi/pyramid_universal_nandi_1.png", width = 12, height = 12, dpi = 300)
