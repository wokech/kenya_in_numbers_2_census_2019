# Kenyan Generations by Universal Classification (Kisii) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kisii/pyramid_universal_kisii_1.png", width = 12, height = 12, dpi = 300)
