# Kenyan Generations by Presidential Era (Kisii) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kisii/pyramid_presidency_kisii_1.png", width = 12, height = 12, dpi = 300)
