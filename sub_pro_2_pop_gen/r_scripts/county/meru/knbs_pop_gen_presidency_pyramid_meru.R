# Kenyan Generations by Presidential Era (Meru) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/meru/pyramid_presidency_meru_1.png", width = 12, height = 12, dpi = 300)
