# Kenyan Generations by Presidential Era (Nairobi City) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/nairobi_city/pyramid_presidency_nairobi_city_1.png", width = 12, height = 12, dpi = 300)
