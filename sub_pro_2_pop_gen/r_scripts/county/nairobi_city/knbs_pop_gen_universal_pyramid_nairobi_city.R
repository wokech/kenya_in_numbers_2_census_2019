# Kenyan Generations by Universal Classification (Nairobi City) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/nairobi_city/pyramid_universal_nairobi_city_1.png", width = 12, height = 12, dpi = 300)
