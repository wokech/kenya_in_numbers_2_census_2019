# Kenyan Generations by Universal Classification (Nairobi City)
...
# Age-sex dataset for Nairobi City

county_df_age_sex_nairobi_city <- county_df_age_sex |>
  filter(County == "Nairobi City")

county_df_age_sex_nairobi_city$Age <- as.numeric(county_df_age_sex_nairobi_city$Age)
...
county_df_age_sex_nairobi_city_male <- county_df_age_sex_nairobi_city |> select(Age, Male)
county_df_age_sex_nairobi_city_male$type <- 'male'
county_df_age_sex_nairobi_city_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_nairobi_city_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_nairobi_city_female <- county_df_age_sex_nairobi_city |> select(Age, Female)
county_df_age_sex_nairobi_city_female$type <- 'female'
county_df_age_sex_nairobi_city_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_nairobi_city_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_nairobi_city_total <- county_df_age_sex_nairobi_city |> select(Age, Total)
county_df_age_sex_nairobi_city_total$type <- 'total'
county_df_age_sex_nairobi_city_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_nairobi_city_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/nairobi_city/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nairobi_city/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nairobi_city/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
