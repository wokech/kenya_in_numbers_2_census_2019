# Kenyan Generations by Universal Classification (Tana River) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/tana_river/pyramid_universal_tana_river_1.png", width = 12, height = 12, dpi = 300)
