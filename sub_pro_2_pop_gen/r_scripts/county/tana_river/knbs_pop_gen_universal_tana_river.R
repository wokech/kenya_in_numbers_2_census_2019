# Kenyan Generations by Universal Classification (Tana River)
...
# Age-sex dataset for Tana River

county_df_age_sex_tana_river <- county_df_age_sex |>
  filter(County == "Tana River")

county_df_age_sex_tana_river$Age <- as.numeric(county_df_age_sex_tana_river$Age)
...
county_df_age_sex_tana_river_male <- county_df_age_sex_tana_river |> select(Age, Male)
county_df_age_sex_tana_river_male$type <- 'male'
county_df_age_sex_tana_river_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_tana_river_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_tana_river_female <- county_df_age_sex_tana_river |> select(Age, Female)
county_df_age_sex_tana_river_female$type <- 'female'
county_df_age_sex_tana_river_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_tana_river_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_tana_river_total <- county_df_age_sex_tana_river |> select(Age, Total)
county_df_age_sex_tana_river_total$type <- 'total'
county_df_age_sex_tana_river_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_tana_river_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/tana_river/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/tana_river/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/tana_river/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
