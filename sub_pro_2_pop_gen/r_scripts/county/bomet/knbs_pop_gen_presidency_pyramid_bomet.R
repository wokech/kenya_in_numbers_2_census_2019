# Kenyan Generations by Presidential Era (Bomet) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/bomet/pyramid_presidency_bomet_1.png", width = 12, height = 12, dpi = 300)
