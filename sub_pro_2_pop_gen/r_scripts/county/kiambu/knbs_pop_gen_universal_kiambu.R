# Kenyan Generations by Universal Classification (Kiambu)
...
# Age-sex dataset for Kiambu

county_df_age_sex_kiambu <- county_df_age_sex |>
  filter(County == "Kiambu")

county_df_age_sex_kiambu$Age <- as.numeric(county_df_age_sex_kiambu$Age)
...
county_df_age_sex_kiambu_male <- county_df_age_sex_kiambu |> select(Age, Male)
county_df_age_sex_kiambu_male$type <- 'male'
county_df_age_sex_kiambu_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kiambu_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kiambu_female <- county_df_age_sex_kiambu |> select(Age, Female)
county_df_age_sex_kiambu_female$type <- 'female'
county_df_age_sex_kiambu_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kiambu_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kiambu_total <- county_df_age_sex_kiambu |> select(Age, Total)
county_df_age_sex_kiambu_total$type <- 'total'
county_df_age_sex_kiambu_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kiambu_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kiambu/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kiambu/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kiambu/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
