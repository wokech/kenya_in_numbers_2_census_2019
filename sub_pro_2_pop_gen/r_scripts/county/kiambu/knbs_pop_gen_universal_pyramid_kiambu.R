# Kenyan Generations by Universal Classification (Kiambu) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kiambu/pyramid_universal_kiambu_1.png", width = 12, height = 12, dpi = 300)
