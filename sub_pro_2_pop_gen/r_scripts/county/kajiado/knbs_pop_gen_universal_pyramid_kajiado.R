# Kenyan Generations by Universal Classification (Kajiado) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kajiado/pyramid_universal_kajiado_1.png", width = 12, height = 12, dpi = 300)
