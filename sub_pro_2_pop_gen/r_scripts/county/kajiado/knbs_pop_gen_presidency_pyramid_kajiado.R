# Kenyan Generations by Presidential Era (Kajiado) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kajiado/pyramid_presidency_kajiado_1.png", width = 12, height = 12, dpi = 300)
