# Kenyan Generations by Universal Classification (Kajiado)
...
# Age-sex dataset for Kajiado

county_df_age_sex_kajiado <- county_df_age_sex |>
  filter(County == "Kajiado")

county_df_age_sex_kajiado$Age <- as.numeric(county_df_age_sex_kajiado$Age)
...
county_df_age_sex_kajiado_male <- county_df_age_sex_kajiado |> select(Age, Male)
county_df_age_sex_kajiado_male$type <- 'male'
county_df_age_sex_kajiado_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kajiado_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kajiado_female <- county_df_age_sex_kajiado |> select(Age, Female)
county_df_age_sex_kajiado_female$type <- 'female'
county_df_age_sex_kajiado_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kajiado_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kajiado_total <- county_df_age_sex_kajiado |> select(Age, Total)
county_df_age_sex_kajiado_total$type <- 'total'
county_df_age_sex_kajiado_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kajiado_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kajiado/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kajiado/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kajiado/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
