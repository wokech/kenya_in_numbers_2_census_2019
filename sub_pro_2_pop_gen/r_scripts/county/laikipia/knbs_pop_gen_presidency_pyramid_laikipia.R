# Kenyan Generations by Presidential Era (Laikipia) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/laikipia/pyramid_presidency_laikipia_1.png", width = 12, height = 12, dpi = 300)
