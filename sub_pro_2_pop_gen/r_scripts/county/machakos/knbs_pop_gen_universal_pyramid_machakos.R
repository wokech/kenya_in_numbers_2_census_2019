# Kenyan Generations by Universal Classification (Machakos) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/machakos/pyramid_universal_machakos_1.png", width = 12, height = 12, dpi = 300)
