# Kenyan Generations by Presidential Era (Machakos) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/machakos/pyramid_presidency_machakos_1.png", width = 12, height = 12, dpi = 300)
