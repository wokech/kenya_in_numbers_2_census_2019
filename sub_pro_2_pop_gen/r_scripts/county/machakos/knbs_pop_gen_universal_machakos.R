# Kenyan Generations by Universal Classification (Machakos)
...
# Age-sex dataset for Machakos

county_df_age_sex_machakos <- county_df_age_sex |>
  filter(County == "Machakos")

county_df_age_sex_machakos$Age <- as.numeric(county_df_age_sex_machakos$Age)
...
county_df_age_sex_machakos_male <- county_df_age_sex_machakos |> select(Age, Male)
county_df_age_sex_machakos_male$type <- 'male'
county_df_age_sex_machakos_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_machakos_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_machakos_female <- county_df_age_sex_machakos |> select(Age, Female)
county_df_age_sex_machakos_female$type <- 'female'
county_df_age_sex_machakos_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_machakos_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_machakos_total <- county_df_age_sex_machakos |> select(Age, Total)
county_df_age_sex_machakos_total$type <- 'total'
county_df_age_sex_machakos_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_machakos_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/machakos/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/machakos/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/machakos/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
