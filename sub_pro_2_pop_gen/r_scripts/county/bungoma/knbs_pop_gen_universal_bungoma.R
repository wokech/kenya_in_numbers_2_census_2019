# Kenyan Generations by Universal Classification (Bungoma)
...
# Age-sex dataset for Bungoma

county_df_age_sex_bungoma <- county_df_age_sex |>
  filter(County == "Bungoma")

county_df_age_sex_bungoma$Age <- as.numeric(county_df_age_sex_bungoma$Age)
...
county_df_age_sex_bungoma_male <- county_df_age_sex_bungoma |> select(Age, Male)
county_df_age_sex_bungoma_male$type <- 'male'
county_df_age_sex_bungoma_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_bungoma_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_bungoma_female <- county_df_age_sex_bungoma |> select(Age, Female)
county_df_age_sex_bungoma_female$type <- 'female'
county_df_age_sex_bungoma_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_bungoma_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_bungoma_total <- county_df_age_sex_bungoma |> select(Age, Total)
county_df_age_sex_bungoma_total$type <- 'total'
county_df_age_sex_bungoma_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_bungoma_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/bungoma/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/bungoma/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/bungoma/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
