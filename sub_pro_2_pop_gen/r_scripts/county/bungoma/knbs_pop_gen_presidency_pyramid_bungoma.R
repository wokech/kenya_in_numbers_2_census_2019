# Kenyan Generations by Presidential Era (Bungoma) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/bungoma/pyramid_presidency_bungoma_1.png", width = 12, height = 12, dpi = 300)
