# Kenyan Generations by Universal Classification (Kakamega)
...
# Age-sex dataset for Kakamega

county_df_age_sex_kakamega <- county_df_age_sex |>
  filter(County == "Kakamega")

county_df_age_sex_kakamega$Age <- as.numeric(county_df_age_sex_kakamega$Age)
...
county_df_age_sex_kakamega_male <- county_df_age_sex_kakamega |> select(Age, Male)
county_df_age_sex_kakamega_male$type <- 'male'
county_df_age_sex_kakamega_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kakamega_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kakamega_female <- county_df_age_sex_kakamega |> select(Age, Female)
county_df_age_sex_kakamega_female$type <- 'female'
county_df_age_sex_kakamega_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kakamega_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kakamega_total <- county_df_age_sex_kakamega |> select(Age, Total)
county_df_age_sex_kakamega_total$type <- 'total'
county_df_age_sex_kakamega_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kakamega_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kakamega/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kakamega/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kakamega/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
