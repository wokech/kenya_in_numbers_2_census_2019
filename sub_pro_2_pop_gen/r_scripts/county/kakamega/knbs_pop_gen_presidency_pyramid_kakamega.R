# Kenyan Generations by Presidential Era (Kakamega) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kakamega/pyramid_presidency_kakamega_1.png", width = 12, height = 12, dpi = 300)
