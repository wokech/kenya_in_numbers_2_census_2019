# Kenyan Generations by Universal Classification (Samburu)
...
# Age-sex dataset for Samburu

county_df_age_sex_samburu <- county_df_age_sex |>
  filter(County == "Samburu")

county_df_age_sex_samburu$Age <- as.numeric(county_df_age_sex_samburu$Age)
...
county_df_age_sex_samburu_male <- county_df_age_sex_samburu |> select(Age, Male)
county_df_age_sex_samburu_male$type <- 'male'
county_df_age_sex_samburu_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_samburu_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_samburu_female <- county_df_age_sex_samburu |> select(Age, Female)
county_df_age_sex_samburu_female$type <- 'female'
county_df_age_sex_samburu_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_samburu_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_samburu_total <- county_df_age_sex_samburu |> select(Age, Total)
county_df_age_sex_samburu_total$type <- 'total'
county_df_age_sex_samburu_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_samburu_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/samburu/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/samburu/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/samburu/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
