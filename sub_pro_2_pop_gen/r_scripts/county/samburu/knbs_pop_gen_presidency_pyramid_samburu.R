# Kenyan Generations by Presidential Era (Samburu) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/samburu/pyramid_presidency_samburu_1.png", width = 12, height = 12, dpi = 300)
