# Kenyan Generations by Presidential Era (Migori) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/migori/pyramid_presidency_migori_1.png", width = 12, height = 12, dpi = 300)
