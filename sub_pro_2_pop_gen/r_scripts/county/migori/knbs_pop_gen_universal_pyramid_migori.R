# Kenyan Generations by Universal Classification (Migori) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/migori/pyramid_universal_migori_1.png", width = 12, height = 12, dpi = 300)
