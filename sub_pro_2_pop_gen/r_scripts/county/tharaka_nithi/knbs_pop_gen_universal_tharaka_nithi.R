# Kenyan Generations by Universal Classification (Tharaka Nithi)
...
# Age-sex dataset for Tharaka Nithi

county_df_age_sex_tharaka_nithi <- county_df_age_sex |>
  filter(County == "Tharaka Nithi")

county_df_age_sex_tharaka_nithi$Age <- as.numeric(county_df_age_sex_tharaka_nithi$Age)
...
county_df_age_sex_tharaka_nithi_male <- county_df_age_sex_tharaka_nithi |> select(Age, Male)
county_df_age_sex_tharaka_nithi_male$type <- 'male'
county_df_age_sex_tharaka_nithi_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_tharaka_nithi_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_tharaka_nithi_female <- county_df_age_sex_tharaka_nithi |> select(Age, Female)
county_df_age_sex_tharaka_nithi_female$type <- 'female'
county_df_age_sex_tharaka_nithi_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_tharaka_nithi_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_tharaka_nithi_total <- county_df_age_sex_tharaka_nithi |> select(Age, Total)
county_df_age_sex_tharaka_nithi_total$type <- 'total'
county_df_age_sex_tharaka_nithi_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_tharaka_nithi_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/tharaka_nithi/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/tharaka_nithi/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/tharaka_nithi/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
