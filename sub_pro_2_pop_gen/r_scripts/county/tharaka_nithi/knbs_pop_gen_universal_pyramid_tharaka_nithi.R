# Kenyan Generations by Universal Classification (Tharaka Nithi) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/tharaka_nithi/pyramid_universal_tharaka_nithi_1.png", width = 12, height = 12, dpi = 300)
