# Kenyan Generations by Universal Classification (Nyeri)
...
# Age-sex dataset for Nyeri

county_df_age_sex_nyeri <- county_df_age_sex |>
  filter(County == "Nyeri")

county_df_age_sex_nyeri$Age <- as.numeric(county_df_age_sex_nyeri$Age)
...
county_df_age_sex_nyeri_male <- county_df_age_sex_nyeri |> select(Age, Male)
county_df_age_sex_nyeri_male$type <- 'male'
county_df_age_sex_nyeri_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_nyeri_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_nyeri_female <- county_df_age_sex_nyeri |> select(Age, Female)
county_df_age_sex_nyeri_female$type <- 'female'
county_df_age_sex_nyeri_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_nyeri_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_nyeri_total <- county_df_age_sex_nyeri |> select(Age, Total)
county_df_age_sex_nyeri_total$type <- 'total'
county_df_age_sex_nyeri_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_nyeri_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/nyeri/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nyeri/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nyeri/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
