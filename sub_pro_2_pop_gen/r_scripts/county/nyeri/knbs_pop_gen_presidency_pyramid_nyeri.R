# Kenyan Generations by Presidential Era (Nyeri) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/nyeri/pyramid_presidency_nyeri_1.png", width = 12, height = 12, dpi = 300)
