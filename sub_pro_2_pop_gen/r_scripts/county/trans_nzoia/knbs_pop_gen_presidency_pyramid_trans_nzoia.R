# Kenyan Generations by Presidential Era (Trans Nzoia) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/trans_nzoia/pyramid_presidency_trans_nzoia_1.png", width = 12, height = 12, dpi = 300)
