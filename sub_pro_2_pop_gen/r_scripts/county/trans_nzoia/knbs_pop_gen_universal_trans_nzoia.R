# Kenyan Generations by Universal Classification (Trans Nzoia)
...
# Age-sex dataset for Trans Nzoia

county_df_age_sex_trans_nzoia <- county_df_age_sex |>
  filter(County == "Trans Nzoia")

county_df_age_sex_trans_nzoia$Age <- as.numeric(county_df_age_sex_trans_nzoia$Age)
...
county_df_age_sex_trans_nzoia_male <- county_df_age_sex_trans_nzoia |> select(Age, Male)
county_df_age_sex_trans_nzoia_male$type <- 'male'
county_df_age_sex_trans_nzoia_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_trans_nzoia_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_trans_nzoia_female <- county_df_age_sex_trans_nzoia |> select(Age, Female)
county_df_age_sex_trans_nzoia_female$type <- 'female'
county_df_age_sex_trans_nzoia_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_trans_nzoia_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_trans_nzoia_total <- county_df_age_sex_trans_nzoia |> select(Age, Total)
county_df_age_sex_trans_nzoia_total$type <- 'total'
county_df_age_sex_trans_nzoia_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_trans_nzoia_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/trans_nzoia/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/trans_nzoia/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/trans_nzoia/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
