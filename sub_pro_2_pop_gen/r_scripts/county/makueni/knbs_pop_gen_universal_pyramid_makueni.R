# Kenyan Generations by Universal Classification (Makueni) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/makueni/pyramid_universal_makueni_1.png", width = 12, height = 12, dpi = 300)
