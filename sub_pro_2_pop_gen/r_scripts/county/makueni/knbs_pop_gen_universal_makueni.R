# Kenyan Generations by Universal Classification (Makueni)
...
# Age-sex dataset for Makueni

county_df_age_sex_makueni <- county_df_age_sex |>
  filter(County == "Makueni")

county_df_age_sex_makueni$Age <- as.numeric(county_df_age_sex_makueni$Age)
...
county_df_age_sex_makueni_male <- county_df_age_sex_makueni |> select(Age, Male)
county_df_age_sex_makueni_male$type <- 'male'
county_df_age_sex_makueni_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_makueni_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_makueni_female <- county_df_age_sex_makueni |> select(Age, Female)
county_df_age_sex_makueni_female$type <- 'female'
county_df_age_sex_makueni_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_makueni_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_makueni_total <- county_df_age_sex_makueni |> select(Age, Total)
county_df_age_sex_makueni_total$type <- 'total'
county_df_age_sex_makueni_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_makueni_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/makueni/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/makueni/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/makueni/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
