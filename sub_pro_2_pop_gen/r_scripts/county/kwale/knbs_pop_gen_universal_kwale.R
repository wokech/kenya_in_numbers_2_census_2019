# Kenyan Generations by Universal Classification (Kwale)
...
# Age-sex dataset for Kwale

county_df_age_sex_kwale <- county_df_age_sex |>
  filter(County == "Kwale")

county_df_age_sex_kwale$Age <- as.numeric(county_df_age_sex_kwale$Age)
...
county_df_age_sex_kwale_male <- county_df_age_sex_kwale |> select(Age, Male)
county_df_age_sex_kwale_male$type <- 'male'
county_df_age_sex_kwale_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kwale_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kwale_female <- county_df_age_sex_kwale |> select(Age, Female)
county_df_age_sex_kwale_female$type <- 'female'
county_df_age_sex_kwale_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kwale_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kwale_total <- county_df_age_sex_kwale |> select(Age, Total)
county_df_age_sex_kwale_total$type <- 'total'
county_df_age_sex_kwale_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kwale_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kwale/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kwale/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kwale/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
