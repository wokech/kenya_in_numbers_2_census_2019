# Kenyan Generations by Universal Classification (Kwale) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kwale/pyramid_universal_kwale_1.png", width = 12, height = 12, dpi = 300)
