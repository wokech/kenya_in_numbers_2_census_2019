# Kenyan Generations by Presidential Era (Kwale) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kwale/pyramid_presidency_kwale_1.png", width = 12, height = 12, dpi = 300)
