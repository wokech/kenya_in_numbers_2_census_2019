# Kenyan Generations by Presidential Era (Garissa) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/garissa/pyramid_presidency_garissa_1.png", width = 12, height = 12, dpi = 300)
