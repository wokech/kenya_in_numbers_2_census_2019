# Kenyan Generations by Universal Classification (Garissa) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/garissa/pyramid_universal_garissa_1.png", width = 12, height = 12, dpi = 300)
