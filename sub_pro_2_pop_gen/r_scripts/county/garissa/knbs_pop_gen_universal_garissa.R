# Kenyan Generations by Universal Classification (Garissa)
...
# Age-sex dataset for Garissa

county_df_age_sex_garissa <- county_df_age_sex |>
  filter(County == "Garissa")

county_df_age_sex_garissa$Age <- as.numeric(county_df_age_sex_garissa$Age)
...
county_df_age_sex_garissa_male <- county_df_age_sex_garissa |> select(Age, Male)
county_df_age_sex_garissa_male$type <- 'male'
county_df_age_sex_garissa_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_garissa_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_garissa_female <- county_df_age_sex_garissa |> select(Age, Female)
county_df_age_sex_garissa_female$type <- 'female'
county_df_age_sex_garissa_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_garissa_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_garissa_total <- county_df_age_sex_garissa |> select(Age, Total)
county_df_age_sex_garissa_total$type <- 'total'
county_df_age_sex_garissa_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_garissa_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/garissa/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/garissa/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/garissa/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
