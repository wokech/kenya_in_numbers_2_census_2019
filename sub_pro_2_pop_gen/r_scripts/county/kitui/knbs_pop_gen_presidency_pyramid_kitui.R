# Kenyan Generations by Presidential Era (Kitui) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kitui/pyramid_presidency_kitui_1.png", width = 12, height = 12, dpi = 300)
