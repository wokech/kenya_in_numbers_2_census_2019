# Kenyan Generations by Universal Classification (Kitui) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kitui/pyramid_universal_kitui_1.png", width = 12, height = 12, dpi = 300)
