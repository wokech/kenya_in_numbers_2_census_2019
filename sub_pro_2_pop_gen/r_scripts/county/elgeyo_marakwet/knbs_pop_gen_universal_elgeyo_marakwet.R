# Kenyan Generations by Universal Classification (Elgeyo Marakwet)
...
# Age-sex dataset for Elgeyo Marakwet

county_df_age_sex_elgeyo_marakwet <- county_df_age_sex |>
  filter(County == "Elgeyo Marakwet")

county_df_age_sex_elgeyo_marakwet$Age <- as.numeric(county_df_age_sex_elgeyo_marakwet$Age)
...
county_df_age_sex_elgeyo_marakwet_male <- county_df_age_sex_elgeyo_marakwet |> select(Age, Male)
county_df_age_sex_elgeyo_marakwet_male$type <- 'male'
county_df_age_sex_elgeyo_marakwet_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_elgeyo_marakwet_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_elgeyo_marakwet_female <- county_df_age_sex_elgeyo_marakwet |> select(Age, Female)
county_df_age_sex_elgeyo_marakwet_female$type <- 'female'
county_df_age_sex_elgeyo_marakwet_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_elgeyo_marakwet_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_elgeyo_marakwet_total <- county_df_age_sex_elgeyo_marakwet |> select(Age, Total)
county_df_age_sex_elgeyo_marakwet_total$type <- 'total'
county_df_age_sex_elgeyo_marakwet_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_elgeyo_marakwet_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/elgeyo_marakwet/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/elgeyo_marakwet/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/elgeyo_marakwet/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
