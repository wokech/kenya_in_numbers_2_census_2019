# Kenyan Generations by Universal Classification (Elgeyo Marakwet) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/elgeyo_marakwet/pyramid_universal_elgeyo_marakwet_1.png", width = 12, height = 12, dpi = 300)
