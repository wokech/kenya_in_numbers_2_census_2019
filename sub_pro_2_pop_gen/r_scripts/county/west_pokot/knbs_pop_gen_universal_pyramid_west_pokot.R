# Kenyan Generations by Universal Classification (West Pokot) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/west_pokot/pyramid_universal_west_pokot_1.png", width = 12, height = 12, dpi = 300)
