# Kenyan Generations by Universal Classification (West Pokot)
...
# Age-sex dataset for West Pokot

county_df_age_sex_west_pokot <- county_df_age_sex |>
  filter(County == "West Pokot")

county_df_age_sex_west_pokot$Age <- as.numeric(county_df_age_sex_west_pokot$Age)
...
county_df_age_sex_west_pokot_male <- county_df_age_sex_west_pokot |> select(Age, Male)
county_df_age_sex_west_pokot_male$type <- 'male'
county_df_age_sex_west_pokot_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_west_pokot_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_west_pokot_female <- county_df_age_sex_west_pokot |> select(Age, Female)
county_df_age_sex_west_pokot_female$type <- 'female'
county_df_age_sex_west_pokot_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_west_pokot_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_west_pokot_total <- county_df_age_sex_west_pokot |> select(Age, Total)
county_df_age_sex_west_pokot_total$type <- 'total'
county_df_age_sex_west_pokot_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_west_pokot_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/west_pokot/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/west_pokot/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/west_pokot/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
