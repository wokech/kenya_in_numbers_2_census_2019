# Kenyan Generations by Presidential Era (West Pokot) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/west_pokot/pyramid_presidency_west_pokot_1.png", width = 12, height = 12, dpi = 300)
