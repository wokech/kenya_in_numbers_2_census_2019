# Kenyan Generations by Universal Classification (Baringo)
...
# Age-sex dataset for Baringo

county_df_age_sex_baringo <- county_df_age_sex |>
  filter(County == "Baringo")

county_df_age_sex_baringo$Age <- as.numeric(county_df_age_sex_baringo$Age)
...
county_df_age_sex_baringo_male <- county_df_age_sex_baringo |> select(Age, Male)
county_df_age_sex_baringo_male$type <- 'male'
county_df_age_sex_baringo_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_baringo_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_baringo_female <- county_df_age_sex_baringo |> select(Age, Female)
county_df_age_sex_baringo_female$type <- 'female'
county_df_age_sex_baringo_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_baringo_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_baringo_total <- county_df_age_sex_baringo |> select(Age, Total)
county_df_age_sex_baringo_total$type <- 'total'
county_df_age_sex_baringo_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_baringo_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/baringo/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/baringo/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/baringo/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
