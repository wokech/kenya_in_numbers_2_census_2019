# Kenyan Generations by Presidential Era (Baringo) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/baringo/pyramid_presidency_baringo_1.png", width = 12, height = 12, dpi = 300)
