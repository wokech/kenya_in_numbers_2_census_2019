# Kenyan Generations by Universal Classification (Embu)
...
# Age-sex dataset for Embu

county_df_age_sex_embu <- county_df_age_sex |>
  filter(County == "Embu")

county_df_age_sex_embu$Age <- as.numeric(county_df_age_sex_embu$Age)
...
county_df_age_sex_embu_male <- county_df_age_sex_embu |> select(Age, Male)
county_df_age_sex_embu_male$type <- 'male'
county_df_age_sex_embu_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_embu_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_embu_female <- county_df_age_sex_embu |> select(Age, Female)
county_df_age_sex_embu_female$type <- 'female'
county_df_age_sex_embu_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_embu_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_embu_total <- county_df_age_sex_embu |> select(Age, Total)
county_df_age_sex_embu_total$type <- 'total'
county_df_age_sex_embu_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_embu_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/embu/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/embu/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/embu/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
