# Kenyan Generations by Universal Classification (Embu) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/embu/pyramid_universal_embu_1.png", width = 12, height = 12, dpi = 300)
