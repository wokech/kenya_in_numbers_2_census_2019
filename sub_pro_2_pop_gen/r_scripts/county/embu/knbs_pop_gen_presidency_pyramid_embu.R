# Kenyan Generations by Presidential Era (Embu) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/embu/pyramid_presidency_embu_1.png", width = 12, height = 12, dpi = 300)
