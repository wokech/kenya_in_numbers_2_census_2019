# Kenyan Generations by Universal Classification (Turkana) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/turkana/pyramid_universal_turkana_1.png", width = 12, height = 12, dpi = 300)
