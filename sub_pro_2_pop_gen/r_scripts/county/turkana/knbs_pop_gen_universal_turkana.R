# Kenyan Generations by Universal Classification (Turkana)
...
# Age-sex dataset for Turkana

county_df_age_sex_turkana <- county_df_age_sex |>
  filter(County == "Turkana")

county_df_age_sex_turkana$Age <- as.numeric(county_df_age_sex_turkana$Age)
...
county_df_age_sex_turkana_male <- county_df_age_sex_turkana |> select(Age, Male)
county_df_age_sex_turkana_male$type <- 'male'
county_df_age_sex_turkana_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_turkana_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_turkana_female <- county_df_age_sex_turkana |> select(Age, Female)
county_df_age_sex_turkana_female$type <- 'female'
county_df_age_sex_turkana_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_turkana_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_turkana_total <- county_df_age_sex_turkana |> select(Age, Total)
county_df_age_sex_turkana_total$type <- 'total'
county_df_age_sex_turkana_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_turkana_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/turkana/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/turkana/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/turkana/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
