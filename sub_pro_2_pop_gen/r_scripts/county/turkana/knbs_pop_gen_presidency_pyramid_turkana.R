# Kenyan Generations by Presidential Era (Turkana) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/turkana/pyramid_presidency_turkana_1.png", width = 12, height = 12, dpi = 300)
