# Kenyan Generations by Universal Classification (Vihiga) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/vihiga/pyramid_universal_vihiga_1.png", width = 12, height = 12, dpi = 300)
