# Kenyan Generations by Presidential Era (Nyandarua) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/nyandarua/pyramid_presidency_nyandarua_1.png", width = 12, height = 12, dpi = 300)
