# Kenyan Generations by Presidential Era (Isiolo) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/isiolo/pyramid_presidency_isiolo_1.png", width = 12, height = 12, dpi = 300)
