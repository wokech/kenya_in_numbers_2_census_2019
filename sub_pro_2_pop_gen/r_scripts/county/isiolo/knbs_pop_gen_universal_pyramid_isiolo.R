# Kenyan Generations by Universal Classification (Isiolo) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/isiolo/pyramid_universal_isiolo_1.png", width = 12, height = 12, dpi = 300)
