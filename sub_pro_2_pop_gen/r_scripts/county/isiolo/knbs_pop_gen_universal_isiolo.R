# Kenyan Generations by Universal Classification (Isiolo)
...
# Age-sex dataset for Isiolo

county_df_age_sex_isiolo <- county_df_age_sex |>
  filter(County == "Isiolo")

county_df_age_sex_isiolo$Age <- as.numeric(county_df_age_sex_isiolo$Age)
...
county_df_age_sex_isiolo_male <- county_df_age_sex_isiolo |> select(Age, Male)
county_df_age_sex_isiolo_male$type <- 'male'
county_df_age_sex_isiolo_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_isiolo_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_isiolo_female <- county_df_age_sex_isiolo |> select(Age, Female)
county_df_age_sex_isiolo_female$type <- 'female'
county_df_age_sex_isiolo_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_isiolo_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_isiolo_total <- county_df_age_sex_isiolo |> select(Age, Total)
county_df_age_sex_isiolo_total$type <- 'total'
county_df_age_sex_isiolo_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_isiolo_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/isiolo/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/isiolo/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/isiolo/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
