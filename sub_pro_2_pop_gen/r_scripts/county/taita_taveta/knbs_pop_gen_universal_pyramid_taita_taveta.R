# Kenyan Generations by Universal Classification (Taita Taveta) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/taita_taveta/pyramid_universal_taita_taveta_1.png", width = 12, height = 12, dpi = 300)
