# Kenyan Generations by Universal Classification (Taita Taveta)
...
# Age-sex dataset for Taita Taveta

county_df_age_sex_taita_taveta <- county_df_age_sex |>
  filter(County == "Taita Taveta")

county_df_age_sex_taita_taveta$Age <- as.numeric(county_df_age_sex_taita_taveta$Age)
...
county_df_age_sex_taita_taveta_male <- county_df_age_sex_taita_taveta |> select(Age, Male)
county_df_age_sex_taita_taveta_male$type <- 'male'
county_df_age_sex_taita_taveta_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_taita_taveta_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_taita_taveta_female <- county_df_age_sex_taita_taveta |> select(Age, Female)
county_df_age_sex_taita_taveta_female$type <- 'female'
county_df_age_sex_taita_taveta_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_taita_taveta_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_taita_taveta_total <- county_df_age_sex_taita_taveta |> select(Age, Total)
county_df_age_sex_taita_taveta_total$type <- 'total'
county_df_age_sex_taita_taveta_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_taita_taveta_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/taita_taveta/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/taita_taveta/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/taita_taveta/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
