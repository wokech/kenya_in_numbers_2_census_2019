# Kenyan Generations by Presidential Era (Taita Taveta) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/taita_taveta/pyramid_presidency_taita_taveta_1.png", width = 12, height = 12, dpi = 300)
