# Kenyan Generations by Universal Classification (Nakuru)
...
# Age-sex dataset for Nakuru

county_df_age_sex_nakuru <- county_df_age_sex |>
  filter(County == "Nakuru")

county_df_age_sex_nakuru$Age <- as.numeric(county_df_age_sex_nakuru$Age)
...
county_df_age_sex_nakuru_male <- county_df_age_sex_nakuru |> select(Age, Male)
county_df_age_sex_nakuru_male$type <- 'male'
county_df_age_sex_nakuru_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_nakuru_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_nakuru_female <- county_df_age_sex_nakuru |> select(Age, Female)
county_df_age_sex_nakuru_female$type <- 'female'
county_df_age_sex_nakuru_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_nakuru_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_nakuru_total <- county_df_age_sex_nakuru |> select(Age, Total)
county_df_age_sex_nakuru_total$type <- 'total'
county_df_age_sex_nakuru_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_nakuru_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/nakuru/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nakuru/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/nakuru/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
