# Kenyan Generations by Universal Classification (Nakuru) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/nakuru/pyramid_universal_nakuru_1.png", width = 12, height = 12, dpi = 300)
