# Kenyan Generations by Presidential Era (Uasin Gishu) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/uasin_gishu/pyramid_presidency_uasin_gishu_1.png", width = 12, height = 12, dpi = 300)
