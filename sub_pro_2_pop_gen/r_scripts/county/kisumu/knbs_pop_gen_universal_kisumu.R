# Kenyan Generations by Universal Classification (Kisumu)
...
# Age-sex dataset for Kisumu

county_df_age_sex_kisumu <- county_df_age_sex |>
  filter(County == "Kisumu")

county_df_age_sex_kisumu$Age <- as.numeric(county_df_age_sex_kisumu$Age)
...
county_df_age_sex_kisumu_male <- county_df_age_sex_kisumu |> select(Age, Male)
county_df_age_sex_kisumu_male$type <- 'male'
county_df_age_sex_kisumu_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_kisumu_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_kisumu_female <- county_df_age_sex_kisumu |> select(Age, Female)
county_df_age_sex_kisumu_female$type <- 'female'
county_df_age_sex_kisumu_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_kisumu_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_kisumu_total <- county_df_age_sex_kisumu |> select(Age, Total)
county_df_age_sex_kisumu_total$type <- 'total'
county_df_age_sex_kisumu_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_kisumu_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/kisumu/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kisumu/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/kisumu/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
