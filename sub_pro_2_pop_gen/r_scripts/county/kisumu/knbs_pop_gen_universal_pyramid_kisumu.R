# Kenyan Generations by Universal Classification (Kisumu) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/kisumu/pyramid_universal_kisumu_1.png", width = 12, height = 12, dpi = 300)
