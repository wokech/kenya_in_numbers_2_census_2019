# Kenyan Generations by Universal Classification (Marsabit) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/marsabit/pyramid_universal_marsabit_1.png", width = 12, height = 12, dpi = 300)
