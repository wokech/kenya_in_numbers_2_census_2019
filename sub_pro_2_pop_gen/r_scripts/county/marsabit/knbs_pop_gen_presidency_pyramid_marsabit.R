# Kenyan Generations by Presidential Era (Marsabit) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/marsabit/pyramid_presidency_marsabit_1.png", width = 12, height = 12, dpi = 300)
