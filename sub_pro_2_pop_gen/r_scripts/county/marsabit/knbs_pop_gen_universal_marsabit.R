# Kenyan Generations by Universal Classification (Marsabit)
...
# Age-sex dataset for Marsabit

county_df_age_sex_marsabit <- county_df_age_sex |>
  filter(County == "Marsabit")

county_df_age_sex_marsabit$Age <- as.numeric(county_df_age_sex_marsabit$Age)
...
county_df_age_sex_marsabit_male <- county_df_age_sex_marsabit |> select(Age, Male)
county_df_age_sex_marsabit_male$type <- 'male'
county_df_age_sex_marsabit_male$ref_year <- '2019'
k_pop_male <- county_df_age_sex_marsabit_male |> 
  rename(
    age = Age,
    population = Male,
    type = type
...
county_df_age_sex_marsabit_female <- county_df_age_sex_marsabit |> select(Age, Female)
county_df_age_sex_marsabit_female$type <- 'female'
county_df_age_sex_marsabit_female$ref_year <- '2019'
k_pop_female <- county_df_age_sex_marsabit_female |> 
  rename(
    age = Age,
    population = Female,
    type = type
...
county_df_age_sex_marsabit_total <- county_df_age_sex_marsabit |> select(Age, Total)
county_df_age_sex_marsabit_total$type <- 'total'
county_df_age_sex_marsabit_total$ref_year <- '2019' # reference year = 2019

k_pop_total <- county_df_age_sex_marsabit_total |> 
  rename(
    age = Age,
    population = Total,
    type = type
...
ggsave("sub_pro_2_pop_gen/images/county/marsabit/knbs_pop_generation_2019_universal_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/marsabit/knbs_pop_generation_2019_universal_2.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/county/marsabit/knbs_pop_generation_2019_universal_3.png", width = 12, height = 12, dpi = 300)
