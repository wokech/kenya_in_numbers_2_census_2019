# Kenyan Generations by Presidential Era (Mombasa) - PYRAMID
...
ggsave("sub_pro_2_pop_gen/images/county/mombasa/pyramid_presidency_mombasa_1.png", width = 12, height = 12, dpi = 300)
