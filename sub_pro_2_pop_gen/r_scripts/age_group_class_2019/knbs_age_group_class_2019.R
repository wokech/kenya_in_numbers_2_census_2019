...
k_pop_male_age_group <- k_pop_male |>
  mutate (age_group = case_when (
    birth_year < 1960 ~ 'Elder\n(60+yrs)',
    birth_year < 1984 & birth_year >= 1960 ~ 'Adult\n(36-59 yrs)',
    birth_year < 2002 & birth_year >= 1984 ~ 'Young Adult\n(Youth, 18-35 yrs)',
    birth_year < 2007 & birth_year >= 2002 ~ 'Adolescent\n(13-17 yrs)',
    birth_year < 2018 & birth_year >= 2007 ~ 'Young Child\n(2-12 yrs)',
    birth_year >= 2018 ~ 'Infant\n(< 2 yrs)'),
    rank = case_when (
      birth_year < 1960 ~ '1',
      birth_year < 1984 & birth_year >= 1960 ~ '2',
      birth_year < 2002 & birth_year >= 1984 ~ '3',
      birth_year < 2007 & birth_year >= 2002 ~ '4',
      birth_year < 2018 & birth_year >= 2007 ~ '5',
      birth_year >= 2018 ~ '6'))
...
gg1 <- k_pop_male_age_group |> 
  ...
  filter(birth_year %in% c('1919', '1959', '1983', '2001', '2006', '2017', '2019'))
#View(gg1)
...
ggsave("sub_pro_2_pop_gen/images/age_group_class_2019/knbs_age_group_class_male_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/age_group_class_2019/knbs_age_group_class_female_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/age_group_class_2019/knbs_age_group_class_total_1.png", width = 12, height = 12, dpi = 300)
