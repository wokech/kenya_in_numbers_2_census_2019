...
k_pop_male_age_group <- k_pop_male |>
  mutate (age_group = case_when (
    birth_year < 1960 ~ 'Senior\nCitizen',
    birth_year < 2002 & birth_year >= 1960 ~ 'Work\nEligible',
    birth_year >= 2002 ~ 'Child'),
    rank = case_when (
      birth_year < 1960 ~ '1',
      birth_year < 2002 & birth_year >= 1960 ~ '2',
      birth_year >= 2002 ~ '3'))
...
gg1 <- k_pop_male_age_group |> 
  ...
  filter(birth_year %in% c('1919', '1960', '2001', '2019'))
#View(gg1)
...
ggsave("sub_pro_2_pop_gen/images/work_eligible/knbs_work_eligible_male_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/work_eligible/knbs_work_eligible_female_1.png", width = 12, height = 12, dpi = 300)
...
ggsave("sub_pro_2_pop_gen/images/work_eligible/knbs_work_eligible_total_1.png", width = 12, height = 12, dpi = 300)