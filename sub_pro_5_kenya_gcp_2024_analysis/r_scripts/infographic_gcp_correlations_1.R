...
################################################################################
# POVERTY CORRELATIONS (WITH NAIROBI)
################################################################################
...
ggplot(merged_all, aes(x = used_internet_percent, y = x2022_percent)) +
  ...
  geom_text_repel(data = subset(merged_all, 
                                used_internet_percent > internet_thresh & x2022_percent > poverty_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Internet Usage (%)", y = "Poverty Incidence (%)", title = "") +
  annotate("rect", xmin = internet_thresh, xmax = Inf,
           ymin = poverty_thresh, ymax = Inf, alpha = 0.2, fill = "pink") +
...
ggplot(merged_all, aes(x = television_percent, y = x2022_percent)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                television_percent > television_thresh & x2022_percent > poverty_thresh),
                  aes(label = residence_county), color = "black", size = 8) +  
...
ggplot(merged_all, aes(x = computer_percent, y = x2022_percent)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                computer_percent > computer_thresh & x2022_percent > poverty_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
...
ggplot(merged_all, aes(x = mobile_phone_percent, y = x2022_percent)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                mobile_phone_percent > mobile_thresh & x2022_percent > poverty_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
...
################################################################################
# POVERTY CORRELATIONS (WITHOUT NAIROBI)
################################################################################

# Households that report to using the internet (KDHS, %)

# Thresholds
internet_thresh_no_nai <- median(merged_all_no_nai$used_internet_percent)
poverty_thresh_no_nai <- median(merged_all_no_nai$x2022_percent)

ggplot(merged_all_no_nai, aes(x = used_internet_percent, y = x2022_percent)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all_no_nai, 
                                used_internet_percent > internet_thresh_no_nai & x2022_percent > poverty_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Internet Usage (%)", y = "Poverty Incidence (%)", title = "") +
  annotate("rect", xmin = internet_thresh_no_nai, xmax = Inf,
           ymin = poverty_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = poverty_thresh_no_nai, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = internet_thresh_no_nai, linetype = "dashed", color = "gray") +
  theme_minimal() +
  theme(axis.title.x =element_text(size = 32),
        axis.title.y =element_text(size = 32, angle = 90),
        axis.text.x =element_text(size = 24),
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/poverty_internet_no_nai.png", width = 12, height = 12, dpi = 300)

# Households with access to a television (KDHS, %) 

# Thresholds
television_thresh_no_nai <- median(merged_all_no_nai$television_percent)
poverty_thresh_no_nai <- median(merged_all_no_nai$x2022_percent)

ggplot(merged_all_no_nai, aes(x = television_percent, y = x2022_percent)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all_no_nai, 
                                television_percent > television_thresh_no_nai & x2022_percent > poverty_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Television Ownership (%)", y = "Poverty Incidence (%)", title = "") +
  annotate("rect", xmin = television_thresh_no_nai, xmax = Inf,
           ymin = poverty_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = poverty_thresh_no_nai, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = television_thresh_no_nai, linetype = "dashed", color = "gray") +
  theme_minimal() +
  theme(axis.title.x =element_text(size = 32),
        axis.title.y =element_text(size = 32, angle = 90),
        axis.text.x =element_text(size = 24),
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/poverty_television_no_nai.png", width = 12, height = 12, dpi = 300)

# Households with access to a computer (KDHS, %) 

# Thresholds
computer_thresh_no_nai <- median(merged_all_no_nai$computer_percent)
poverty_thresh_no_nai <- median(merged_all_no_nai$x2022_percent)

ggplot(merged_all_no_nai, aes(x = computer_percent, y = x2022_percent)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all_no_nai, 
                                computer_percent > computer_thresh_no_nai & x2022_percent > poverty_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Computer Ownership (%)", y = "Poverty Incidence (%)", title = "") +
  annotate("rect", xmin = computer_thresh_no_nai, xmax = Inf,
           ymin = poverty_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = poverty_thresh_no_nai, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = computer_thresh_no_nai, linetype = "dashed", color = "gray") +
  theme_minimal() +
  theme(axis.title.x =element_text(size = 32),
        axis.title.y =element_text(size = 32, angle = 90),
        axis.text.x =element_text(size = 24),
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/poverty_computer_no_nai.png", width = 12, height = 12, dpi = 300)

# Households having at least one member owning a mobile phone (KDHS, %) 

# Thresholds
mobile_thresh_no_nai <- median(merged_all_no_nai$mobile_phone_percent)
poverty_thresh_no_nai <- median(merged_all_no_nai$x2022_percent)

ggplot(merged_all_no_nai, aes(x = mobile_phone_percent, y = x2022_percent)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                mobile_phone_percent > mobile_thresh_no_nai & x2022_percent > poverty_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Mobile Phone Ownership (%)", y = "Poverty Incidence (%)", title = "") +
  annotate("rect", xmin = mobile_thresh_no_nai, xmax = Inf,
           ymin = poverty_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = poverty_thresh_no_nai, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = mobile_thresh_no_nai, linetype = "dashed", color = "gray") +
  theme_minimal() +
  theme(axis.title.x =element_text(size = 32),
        axis.title.y =element_text(size = 32, angle = 90),
        axis.text.x =element_text(size = 24),
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/poverty_mobile_no_nai.png", width = 12, height = 12, dpi = 300)



################################################################################
# GCP CORRELATIONS (WITH NAIROBI)
################################################################################
...
ggplot(merged_all, aes(x = used_internet_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                used_internet_percent > internet_thresh & x5_year_avg > gcp_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Internet Usage (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = internet_thresh, xmax = Inf,
...
ggplot(merged_all, aes(x = television_percent, y = x5_year_avg)) +
  ...
  geom_text_repel(data = subset(merged_all, 
                                television_percent > television_thresh & x5_year_avg > gcp_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Television Ownership (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = television_thresh, xmax = Inf,
           ymin = gcp_thresh, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = gcp_thresh, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = television_thresh, linetype = "dashed", color = "gray") +
...
ggplot(merged_all, aes(x = computer_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                computer_percent > computer_thresh & x5_year_avg > gcp_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Computer Ownership (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = computer_thresh, xmax = Inf,
           ymin = gcp_thresh, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = gcp_thresh, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = computer_thresh, linetype = "dashed", color = "gray") +
...
ggplot(merged_all, aes(x = mobile_phone_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                mobile_phone_percent > mobile_thresh & x5_year_avg > gcp_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Mobile Phone Ownership (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = mobile_thresh, xmax = Inf,
           ymin = gcp_thresh, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = gcp_thresh, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = mobile_thresh, linetype = "dashed", color = "gray") +
...
################################################################################
# GCP CORRELATIONS (WITHOUT NAIROBI)
################################################################################
...
# Thresholds
internet_thresh_no_nai <- median(merged_all_no_nai$used_internet_percent)
gcp_thresh_no_nai <- median(merged_all_no_nai$x5_year_avg)

ggplot(merged_all_no_nai, aes(x = used_internet_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all_no_nai, 
                                used_internet_percent > internet_thresh_no_nai & x5_year_avg > gcp_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Internet Usage (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = internet_thresh_no_nai, xmax = Inf,
           ymin = gcp_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = gcp_thresh_no_nai, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = internet_thresh_no_nai, linetype = "dashed", color = "gray") +
  theme_minimal() +
  theme(axis.title.x =element_text(size = 32),
        axis.title.y =element_text(size = 32, angle = 90),
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/gcp_internet_no_nai.png", width = 12, height = 12, dpi = 300)
...
ggplot(merged_all_no_nai, aes(x = television_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all_no_nai, 
                                television_percent > television_thresh_no_nai & x5_year_avg > gcp_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Television Ownership (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = television_thresh_no_nai, xmax = Inf,
           ymin = gcp_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/gcp_television_no_nai.png", width = 12, height = 12, dpi = 300)
...
ggplot(merged_all_no_nai, aes(x = computer_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all_no_nai, 
                                computer_percent > computer_thresh_no_nai & x5_year_avg > gcp_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Computer Ownership (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = computer_thresh_no_nai, xmax = Inf,
           ymin = gcp_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/gcp_computer_no_nai.png", width = 12, height = 12, dpi = 300)
...
ggplot(merged_all_no_nai, aes(x = mobile_phone_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all_no_nai, 
                                mobile_phone_percent > mobile_thresh_no_nai & x5_year_avg > gcp_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Mobile Phone Ownership (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = mobile_thresh_no_nai, xmax = Inf,
           ymin = gcp_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/gcp_mobile_no_nai.png", width = 12, height = 12, dpi = 300)
...
ggplot(merged_all, aes(x = x2022_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                x2022_percent > poverty_thresh & x5_year_avg > gcp_thresh),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Poverty Incidence (%)", y = "Share of contribution to GDP (%)", title = "") +
...
ggsave("sub_pro_5_kenya_gcp_2024_analysis/images/infographic_correlations_1/gcp_poverty.png", width = 12, height = 12, dpi = 300)
...
ggplot(merged_all_no_nai, aes(x = x2022_percent, y = x5_year_avg)) +
  geom_jitter(color = "brown4", size = 5) +
  geom_text_repel(data = subset(merged_all, 
                                x2022_percent > poverty_thresh_no_nai & x5_year_avg > gcp_thresh_no_nai),
                  aes(label = residence_county), color = "black", size = 8) +
  labs(x = "Poverty Incidence (%)", y = "Share of contribution to GDP (%)", title = "") +
  annotate("rect", xmin = poverty_thresh_no_nai, xmax = Inf,
           ymin = gcp_thresh_no_nai, ymax = Inf, alpha = 0.2, fill = "pink") +
  geom_hline(yintercept = gcp_thresh_no_nai, linetype = "dashed", color = "gray") +
  geom_vline(xintercept = poverty_thresh_no_nai, linetype = "dashed", color = "gray") +
  theme_minimal() +
  theme(axis.title.x =element_text(size = 32),
        axis.title.y =element_text(size = 32, angle = 90),
        axis.text.x =element_text(size = 24),
